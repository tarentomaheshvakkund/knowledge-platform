...
object ContentConstants {
    ...
    val EXTENDED_CONTENT_ENRICH_PRELIMINARY_ASSESSMENT_CATEGORIES = "extended.content.enrich.preliminary.assessment.categories"
    val EXTENDED_CONTENT_ASSESSMENT_READ_FIELDS = "extended.content.assessment.read.fields"
    ...
    val PRELIMINARY_ASSESSMENT = "preliminaryAssessment"
    ...
    val BLENDED_PROGRAM = "Blended Program"
    val BATCHES = "batches"
    val BATCH_ID = "batchId"
    val BATCH_ATTRIBUTES = "batchAttributes"
    val BP_BATCH_ENROLLMENT_STATS_KEY_PREFIX = "bp:batch:enrollment:stats:"
    val STAT_APPROVED = "approved"
    val STAT_PENDING = "pending"
    val STAT_WITHDRAWN = "withdrawn"
    val STAT_REJECTED = "rejected"
    val TOTAL_APPROVED_COUNT = "totalApprovedCount"
    val TOTAL_PENDING_COUNT = "totalPendingCount"
    val TOTAL_WITHDRAWN_COUNT = "totalWithdrawnCount"
