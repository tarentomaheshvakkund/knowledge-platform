...
import org.sunbird.content.actors.{AppActor, AssetActor, CategoryActor, CollectionActor, ContentActor, EventActor, EventSetActor, ExtendedContentActor, HealthActor, LicenseActor, ObjectActor}
...
class ContentModule extends AbstractModule with AkkaGuiceSupport {
    ...
    override def configure() = {
        ...
        bindActor(classOf[ExtendedContentActor], ActorNames.EXTENDED_CONTENT_ACTOR)
